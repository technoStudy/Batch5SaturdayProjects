...
public class BasePage {
    ...
    protected void selectFromTextMenuByVisibleText(WebElement textMenu, String visibleText){
        wait.until(ExpectedConditions.elementToBeClickable(textMenu));
        Select select = new Select(textMenu);
