...
import project2.*;
import project2.Common2Arrays;
import project2.DiffBetweenMaxMin;
import project2.ReverseArr;
import project2.SameFirstAndLast;
import project2.SumTotal;
...
public class Tests {
    ...
    public void common2Arrays1() {
        ...
        project2.Common2Arrays.main(new String[0]);
        String result = "false";
    ...
    public void diffBetweenMaxMin1() {
        ...
        provideInput(testString);
        project2.DiffBetweenMaxMin.main(new String[0]);
        String result = "14";
        Assert.assertEquals("Tests data is: " + testString, result, getOutput().trim());
    }
    ...
    public void reverseArr1() {
        final String testString = "0 12 23 50 10 2";
        provideInput(testString);
        project2.ReverseArr.main(new String[0]);
    ...
    public void sameFirstAndLast1() {
        final String testString = "0 12 23 50 10 2";
        provideInput(testString);
        project2.SameFirstAndLast.main(new String[0]);
        String result = "false";
        Assert.assertEquals("Tests data is: " + testString, result, getOutput().trim());
    }
